...
import img7 from './static/images/17.jpg';
import img8 from './static/images/18.jpg';
import img9 from './static/images/19.jpg';
import img0 from './static/images/20.jpg';

export function request({offset, activity_id}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    setTimeout(() => {
      ...
      if (offset < len) {
        return resolve({
          offset: offset + 1,
          items: data.slice((offset || 0) * limit, (offset + 1) * limit),
        });
      } else if (offset === len) {
        return resolve({
          offset: '',
